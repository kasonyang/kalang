...
public class GET_FIELD extends Op {
        public kava.opcode.VarObject result;
        public kava.opcode.VarObject v1;
        public kava.opcode.Constant v2;
    public GET_FIELD(kava.opcode.VarObject result,kava.opcode.VarObject v1,kava.opcode.Constant v2){
            this.result = result;
            this.v1 = v1;
            this.v2 = v2;
    ...
    public void setParameter(String key,Object value){
        ...
        if(key == "v2"){this.v2 = (kava.opcode.Constant)value;return;}
    }
}