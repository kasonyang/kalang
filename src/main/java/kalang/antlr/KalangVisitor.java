...
public interface KalangVisitor<T> extends ParseTreeVisitor<T> {
	/**
	 * Visit a parse tree produced by {@link KalangParser#start}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitStart(KalangParser.StartContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitExprNotOp(KalangParser.ExprNotOpContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitExprLogicCmp(KalangParser.ExprLogicCmpContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitExprLogic(KalangParser.ExprLogicContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link KalangParser#modifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitModifier(KalangParser.ModifierContext ctx);
}