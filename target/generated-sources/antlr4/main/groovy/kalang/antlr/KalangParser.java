...
public class KalangParser extends Parser {
	...
	public final CompiliantUnitContext compiliantUnit() throws RecognitionException {
		...
		try {
			...
			{
			setState(82); importDeclList();
			setState(85);
			switch (_input.LA(1)) {
			case CLASS:
				{
				setState(83); ((CompiliantUnitContext)_localctx).classType = match(CLASS);
				}
				break;
			case INTERFACE:
				{
				setState(84); ((CompiliantUnitContext)_localctx).classType = match(INTERFACE);
				}
				break;
			default:
			...
			if (_la==EXTENDS) {
				{
				setState(90); match(EXTENDS);
				setState(91); ((CompiliantUnitContext)_localctx).parentClass = match(Identifier);
				}
			}
			...
			if (_la==IMPLEMENTS) {
				...
				while (_la==COMMA) {
					...
					setState(97); ((CompiliantUnitContext)_localctx).Identifier = match(Identifier);
					((CompiliantUnitContext)_localctx).interfaces.add(((CompiliantUnitContext)_localctx).Identifier);
					}
					}
					setState(102);
	...
	public final ImportDeclContext importDecl() throws RecognitionException {
		...
		try {
			...
			if (_la==STATIC) {
				{
				setState(116); match(STATIC);
				}
			}

			setState(119); importPath();
	...
	public final MethodDeclContext methodDecl() throws RecognitionException {
		...
		try {
			...
			case T__2:
				{
				{
				setState(189); ((MethodDeclContext)_localctx).prefix = match(T__2);
	...
	public final StatListContext statList() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__4) | (1L << T__2) | (1L << T__0) | (1L << BREAK) | (1L << CONTINUE) | (1L << DO) | (1L << DOUBLE) | (1L << FLOAT) | (1L << FOR) | (1L << IF) | (1L << INT) | (1L << LONG) | (1L << NEW) | (1L << RETURN) | (1L << TRY) | (1L << WHILE) | (1L << IntegerLiteral) | (1L << FloatingPointLiteral) | (1L << BooleanLiteral) | (1L << CharacterLiteral) | (1L << StringLiteral) | (1L << NullLiteral) | (1L << LPAREN))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (LBRACE - 65)) | (1L << (LBRACK - 65)) | (1L << (BANG - 65)) | (1L << (TILDE - 65)) | (1L << (INC - 65)) | (1L << (DEC - 65)) | (1L << (ADD - 65)) | (1L << (SUB - 65)) | (1L << (Identifier - 65)))) != 0)) {
				{
				{
				setState(252); stat();
				}
	...
	public static final String _serializedATN =
		...
		"*,.\60\62\64\668:<>@BDFHJLNPR\2\17\4\2MMOO\4\2\6\6\b\b\7\2\26\26\34\34"+
		"##%%ll\3\2WZ\3\2MN\4\2[\\``\3\2YZ\4\2KLRS\4\2QQTT\3\2UV\4\2JJak\3\2WX"+
		"\3\2;@\u025f\2T\3\2\2\2\4r\3\2\2\2\6u\3\2\2\2\b|\3\2\2\2\n\u0081\3\2\2"+
		"\2\f\u0089\3\2\2\2\16\u008f\3\2\2\2\20\u0093\3\2\2\2\22\u00a9\3\2\2\2"+
